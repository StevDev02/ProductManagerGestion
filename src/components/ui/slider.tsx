...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ref={ref}
    className={cn(
      "relative flex bg-[#d1d1d1] w-[300px] h-[8px] touch-none select-none items-center",
      className
    )}
    {...props}
  >
    <SliderPrimitive.Track className="relative bg-[#d1d1d1] h-1.5 w-[300px] grow overflow-hidden rounded-full bg-slate-900/20 dark:bg-slate-50/20">
      <SliderPrimitive.Range className="absolute bg-black h-full bg-slate-900 dark:bg-slate-50" />
